...
jquery__WEBPACK_IMPORTED_MODULE_0__.extend( FixedHeader.prototype, {
	...
	_constructor: function ()
	{
		...
		jquery__WEBPACK_IMPORTED_MODULE_0__(window)
			...
			.on( 'resize'+this.s.namespace, datatables_net__WEBPACK_IMPORTED_MODULE_1__["default"].util.throttle( function () {
...
/***/ "./node_modules/datatables.net-rowreorder-bs5/js/rowReorder.bootstrap5.mjs":
/*!*********************************************************************************!*\
  !*** ./node_modules/datatables.net-rowreorder-bs5/js/rowReorder.bootstrap5.mjs ***!
  \*********************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
var RowReorder = function ( dt, opts ) {
	...
	this.c = jquery__WEBPACK_IMPORTED_MODULE_0__.extend( true, {},
		datatables_net__WEBPACK_IMPORTED_MODULE_1__["default"].defaults.rowReorder,
		RowReorder.defaults,
		opts
	);
	...
	this.s = {
		...
		getDataFn: datatables_net__WEBPACK_IMPORTED_MODULE_1__["default"].ext.oApi._fnGetObjectDataFn( this.c.dataSrc ),
		...
		setDataFn: datatables_net__WEBPACK_IMPORTED_MODULE_1__["default"].ext.oApi._fnSetObjectDataFn( this.c.dataSrc ),
	...
	this.dom = {
		...
		dtScroll: jquery__WEBPACK_IMPORTED_MODULE_0__('div.dataTables_scrollBody', this.s.dt.table().container())
	};
	...
	if ( !this.dom.dtScroll.length ) {
		this.dom.dtScroll = jquery__WEBPACK_IMPORTED_MODULE_0__(this.s.dt.table().container(), 'tbody')
	}
...
jquery__WEBPACK_IMPORTED_MODULE_0__.extend( RowReorder.prototype, {
	/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
	 * Constructor
	 */
	...
	_constructor: function ()
	{
		var that = this;
		var dt = this.s.dt;
		var table = jquery__WEBPACK_IMPORTED_MODULE_0__( dt.table().node() );
		...
		jquery__WEBPACK_IMPORTED_MODULE_0__(dt.table().container()).on( 'mousedown.rowReorder touchstart.rowReorder', this.c.selector, function (e) {
			if ( ! that.c.enable ) {
				return;
			}

			// Ignore excluded children of the selector
			if ( jquery__WEBPACK_IMPORTED_MODULE_0__(e.target).is(that.c.excludedChildren) ) {
				return true;
			}
		...
		dt.on( 'destroy.rowReorder', function () {
			jquery__WEBPACK_IMPORTED_MODULE_0__(dt.table().container()).off( '.rowReorder' );
			dt.off( '.rowReorder' );
		} );
	},
	...
	_cachePositions: function ()
	{
		...
		// for that
		var headerHeight = jquery__WEBPACK_IMPORTED_MODULE_0__( dt.table().node() ).find('thead').outerHeight();

		// Need to pass the nodes through jQuery to get them in document order,
		// not what DataTables thinks it is, since we have been altering the
		// order
		var nodes = jquery__WEBPACK_IMPORTED_MODULE_0__.unique( dt.rows( { page: 'current' } ).nodes().toArray() );
		var middles = jquery__WEBPACK_IMPORTED_MODULE_0__.map( nodes, function ( node, i ) {
			var top = jquery__WEBPACK_IMPORTED_MODULE_0__(node).position().top - headerHeight;

			return (top + top + jquery__WEBPACK_IMPORTED_MODULE_0__(node).outerHeight() ) / 2;
		} );

		this.s.middles = middles;
		this.s.bodyTop = jquery__WEBPACK_IMPORTED_MODULE_0__( dt.table().body() ).offset().top;
		this.s.windowHeight = jquery__WEBPACK_IMPORTED_MODULE_0__(window).height();
		this.s.documentOuterHeight = jquery__WEBPACK_IMPORTED_MODULE_0__(document).outerHeight();
	},
	...
	{
		var dt = this.s.dt;
		var clone = jquery__WEBPACK_IMPORTED_MODULE_0__( dt.table().node().cloneNode(false) )
		...
		var sizes = target.children().map( function () {
			return jquery__WEBPACK_IMPORTED_MODULE_0__(this).width();
		} );
		...
		var cloneParent = jquery__WEBPACK_IMPORTED_MODULE_0__('<div>')
	...
	_emitEvent: function ( name, args )
	{
		this.s.dt.iterator( 'table', function ( ctx, i ) {
			jquery__WEBPACK_IMPORTED_MODULE_0__(ctx.nTable).triggerHandler( name+'.dt', args );
		} );
	},
	...
	_mouseDown: function ( e, target )
	{
		...
		start.nodes = jquery__WEBPACK_IMPORTED_MODULE_0__.unique( dt.rows( { page: 'current' } ).nodes().toArray() );
		...
		// of the drag
		if ( jquery__WEBPACK_IMPORTED_MODULE_0__(window).width() === jquery__WEBPACK_IMPORTED_MODULE_0__(document).width() ) {
			jquery__WEBPACK_IMPORTED_MODULE_0__(document.body).addClass( 'dt-rowReorder-noOverflow' );
		}
	...
	_mouseUp: function ( e )
	{
		...
		jquery__WEBPACK_IMPORTED_MODULE_0__(document).off( '.rowReorder' );
		jquery__WEBPACK_IMPORTED_MODULE_0__(document.body).removeClass( 'dt-rowReorder-noOverflow' );
		...
		var endNodes = jquery__WEBPACK_IMPORTED_MODULE_0__.unique( dt.rows( { page: 'current' } ).nodes().toArray() );
		var idDiff = {};
		var fullDiff = [];
		var diffNodes = [];
		...
		for ( i=0, ien=startNodes.length ; i<ien ; i++ ) {
			if ( startNodes[i] !== endNodes[i] ) {
				...
				fullDiff.push( {
					...
					newPosition: i,
					oldPosition: jquery__WEBPACK_IMPORTED_MODULE_0__.inArray( endNodes[i], startNodes )
				} );
		...
		if ( this.c.editor ) {
			...
			this.c.editor
				.edit(
					diffNodes,
					false,
					jquery__WEBPACK_IMPORTED_MODULE_0__.extend( {submit: 'changed'}, this.c.formOptions )
				)
	...
	_shiftScroll: function ( e )
	{
		...
		if ( windowY < jquery__WEBPACK_IMPORTED_MODULE_0__(window).scrollTop() + buffer ) {
			windowVert = scrollSpeed * -1;
		}
		else if ( windowY > scroll.windowHeight + jquery__WEBPACK_IMPORTED_MODULE_0__(window).scrollTop() - buffer ) {
		...
		if ( ! this.s.scrollInterval && runInterval ) {
			this.s.scrollInterval = setInterval( function () {
				...
				if ( scroll.windowVert ) {
					var top = jquery__WEBPACK_IMPORTED_MODULE_0__(document).scrollTop();
					jquery__WEBPACK_IMPORTED_MODULE_0__(document).scrollTop(top + scroll.windowVert);

					if ( top !== jquery__WEBPACK_IMPORTED_MODULE_0__(document).scrollTop() ) {
...
jquery__WEBPACK_IMPORTED_MODULE_0__.fn.dataTable.RowReorder = RowReorder;
jquery__WEBPACK_IMPORTED_MODULE_0__.fn.DataTable.RowReorder = RowReorder;

// Attach a listener to the document which listens for DataTables initialisation
// events so we can automatically initialise
jquery__WEBPACK_IMPORTED_MODULE_0__(document).on( 'init.dt.dtr', function (e, settings, json) {
	if ( e.namespace !== 'dt' ) {
		return;
	}
...
/* harmony import */ var datatables_net_fixedcolumns_bs5__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! datatables.net-fixedcolumns-bs5 */ "./node_modules/datatables.net-fixedcolumns-bs5/js/fixedColumns.bootstrap5.mjs");
/* harmony import */ var datatables_net_fixedheader_bs5__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! datatables.net-fixedheader-bs5 */ "./node_modules/datatables.net-fixedheader-bs5/js/fixedHeader.bootstrap5.mjs");
/* harmony import */ var datatables_net_rowreorder_bs5__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! datatables.net-rowreorder-bs5 */ "./node_modules/datatables.net-rowreorder-bs5/js/rowReorder.bootstrap5.mjs");
